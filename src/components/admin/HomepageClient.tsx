...
type ProductFlag = { id: number; name: string; isNewArrival: boolean; isBestSeller: boolean };
    ...
    <div>
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <Field label="Background image">
            <ImageUpload
              ...
              onChange={(url, publicId) => setHero({ ...hero, imageUrl: url, imagePublicId: publicId })}
          ...
          <Field label="Eyebrow text">
            <input
              ...
              placeholder="New Horizons — Drop 003"
            />
          </Field>
          <Field label="Headline">
            <input
              ...
              className={inputClass}
              placeholder="Explore New Horizons."
            />
          </Field>
        ...
        <div className="bg-white border border-neutral-200 p-5">
          ...
          <Field label="Background image">
            <ImageUpload
              ...
              publicId={promo.imagePublicId}
              onChange={(url, publicId) => setPromo({ ...promo, imageUrl: url, imagePublicId: publicId })}
              aspectClass="aspect-[16/9]"
            />
          </Field>
          <Field label="Eyebrow text">
            <input
              value={promo.eyebrow}
              onChange={(e) => setPromo({ ...promo, eyebrow: e.target.value })}
              className={inputClass}
              placeholder="Holiday Capsule — Limited Run"
            />
          </Field>
          <Field label="Headline">
            <input
              ...
              className={inputClass}
              placeholder="Built for Those Who Stand Out."
            />
          </Field>
          <Field label="Subtext">
            <input
              value={promo.subtext}
              onChange={(e) => setPromo({ ...promo, subtext: e.target.value })}
              className={inputClass}
              placeholder="Crafted Without Compromise."
            />
          </Field>
        </div>
      </div>
      ...
      <div className="bg-white border border-neutral-200 p-5">
        ...
        <div className="text-xs text-neutral-400 mb-3">
          Controls which products appear in the New Arrivals and Best Sellers rows on the storefront homepage.
        </div>
          ...
          <table className="w-full text-sm min-w-[360px]">
            <thead>
              <tr className="text-left text-neutral-500 font-mono text-[11px] uppercase tracking-wide border-b border-neutral-200">
                ...
                <th className="py-2">New Arrival</th>
                ...
                <tr key={p.id} className="border-b border-neutral-100 last:border-b-0">
                  ...
                  <td className="py-2">
                    <input
                      ...
                      onChange={() => toggleFlag(p.id, "isNewArrival")}
                  ...
                  <td className="py-2">
                    <input
                      ...
                      onChange={() => toggleFlag(p.id, "isBestSeller")}
                      className="cursor-pointer"
                    />
                  </td>
                </tr>
